...
def create_level(island, level):
    ...
    # =========================================================================
        ...
        if level == 0:  # Murky Shallows — intro to swamp, mostly wasps
            ...
            enemies = scale_enemies([
                ...
                Fly(900, 360, 850, 1100, traits=["poison"]),
                Wasp(1200, 540 - 24, 1100, 1450),
                Wasp(1600, 540 - 24, 1500, 1800, traits=["poison"]),
            ...
            enemies = scale_enemies([
                ...
                Fly(400, 260, 350, 550),
                Spider(550, 440 - 28, 500, 650, traits=["poison"]),
                Wasp(700, 540 - 24, 650, 850),
                Fly(1000, 220, 950, 1150, traits=["poison"]),
                Spider(1300, 540 - 28, 1250, 1500),
                Wasp(1450, 420 - 24, 1400, 1600),
                Fly(1600, 260, 1550, 1750),
                Spider(1950, 540 - 28, 1900, 2200, traits=["poison"]),
            ...
            enemies = scale_enemies([
                Wasp(100, 540 - 24, 50, 250),
                Spider(400, 350 - 28, 350, 500, traits=["poison"]),
                Fly(550, 360, 500, 650, traits=["poison"]),
                Wasp(650, 540 - 24, 500, 700),
                Spider(800, 300 - 28, 750, 900, traits=["poison"]),
                ...
                Spider(1850, 380 - 28, 1800, 2000, traits=["poison"]),
                Fly(2000, 220, 1950, 2150),
                Wasp(2350, 540 - 24, 2300, 2550),
                Spider(2550, 420 - 28, 2500, 2700),
                Fly(2700, 260, 2650, 2850, traits=["poison"]),
            ...
            enemies = scale_enemies([
                ...
                Fly(500, 290, 450, 650),
                Spider(800, 540 - 28, 750, 920, traits=["poison"]),
                Wasp(1000, 380 - 24, 950, 1150),
                Fly(1150, 240, 1100, 1300, traits=["poison"]),
    ...
    # =========================================================================
        ...
        if level == 0:  # Crystal Entrance — intro to caves, spiders + wasps
            ...
            enemies = scale_enemies([
                Spider(300, 440 - 28, 250, 400, traits=["shadow"]),
                Wasp(600, 460 - 24, 550, 750),
                Spider(850, 420 - 28, 800, 950, traits=["poison"]),
                Wasp(1000, 340 - 24, 950, 1150),
                Spider(1300, 540 - 28, 1250, 1500),
                Wasp(1450, 400 - 24, 1400, 1600),
                Spider(1750, 440 - 28, 1700, 1900, traits=["shadow"]),
            ...
            enemies = scale_enemies([
                Spider(200, 430 - 28, 150, 350, traits=["shadow"]),
                Fly(350, 270, 300, 500),
                Spider(450, 460 - 28, 400, 550),
                Fly(650, 320, 600, 800, traits=["poison"]),
                Spider(900, 380 - 28, 850, 1000, traits=["shadow"]),
                Fly(1150, 240, 1100, 1300),
                Spider(1300, 540 - 28, 1250, 1450, traits=["poison", "shadow"]),
                Fly(1450, 340, 1400, 1600),
                Spider(1700, 420 - 28, 1650, 1850, traits=["shadow"]),
            ...
            enemies = scale_enemies([
                Spider(250, 430 - 28, 200, 400, traits=["shadow"]),
                Wasp(400, 350 - 24, 350, 550),
                Fly(550, 390, 500, 700, traits=["poison"]),
                Spider(750, 380 - 28, 700, 900, traits=["poison", "shadow"]),
                Wasp(900, 290 - 24, 850, 1050),
                Fly(1050, 420, 1000, 1200),
                Spider(1300, 540 - 28, 1250, 1450),
                Wasp(1400, 400 - 24, 1350, 1550),
                Fly(1550, 250, 1500, 1700, traits=["shadow"]),
                Spider(1850, 540 - 28, 1800, 2000, traits=["shadow"]),
                Wasp(1950, 380 - 24, 1900, 2100),
                Fly(2100, 220, 2050, 2250, traits=["poison"]),
                Spider(2400, 500 - 28, 2350, 2550),
                Wasp(2550, 540 - 24, 2500, 2700),
                Fly(2700, 260, 2650, 2850),
                Spider(3000, 440 - 28, 2950, 3150, traits=["poison", "shadow"]),
            ...
            enemies = scale_enemies([
                Spider(200, 440 - 28, 150, 350, traits=["shadow"]),
                Spider(350, 360 - 28, 300, 500),
                Wasp(500, 450 - 24, 450, 620),
                Spider(700, 380 - 28, 650, 850, traits=["poison"]),
                Spider(850, 290 - 28, 800, 950),
                Fly(1000, 340, 950, 1100),
                Spider(1250, 540 - 28, 1200, 1380, traits=["shadow"]),
                Spider(1350, 400 - 28, 1300, 1500, traits=["poison", "shadow"]),
                Wasp(1500, 300 - 24, 1450, 1650),
                Spider(1650, 400 - 28, 1600, 1750),
                Spider(1900, 540 - 28, 1850, 2050, traits=["shadow"]),
                Fly(2000, 320, 1950, 2150),
                Spider(2150, 280 - 28, 2100, 2300),
                Spider(2300, 400 - 28, 2250, 2450, traits=["poison"]),
                Wasp(2600, 540 - 24, 2550, 2750),
                Spider(2750, 420 - 28, 2700, 2900),
                Spider(2900, 320 - 28, 2850, 3050, traits=["poison", "shadow"]),
            ...
            enemies = scale_enemies([
                ...
                Spider(600, 460 - 28, 550, 720, traits=["poison"]),
                Fly(850, 320, 800, 1050),
                Spider(1050, 300 - 28, 1000, 1200, traits=["poison", "shadow"]),
    ...
    # =========================================================================
        ...
        if level == 0:  # Lava Flats — intro level, wasps and flies, lava gaps
            ...
            enemies = scale_enemies([
                Wasp(200, 540 - 24, 100, 350),
                Fly(600, 360, 550, 800),
                Wasp(700, 540 - 24, 550, 850, traits=["armor"]),
                Fly(1000, 400, 900, 1150, traits=["poison"]),
                Wasp(1300, 540 - 24, 1200, 1500),
                Fly(1400, 360, 1350, 1600),
                Wasp(1800, 540 - 24, 1700, 1950, traits=["armor"]),
                Fly(2150, 360, 2100, 2350, traits=["shadow"]),
            ...
            enemies = scale_enemies([
                ...
                Spider(880, 280 - 28, 830, 980, traits=["poison", "shadow"]),
                Fly(1030, 340, 980, 1200, traits=["armor"]),
                Wasp(1150, 540 - 24, 1100, 1300),
                Fly(1430, 320, 1380, 1550),
                Spider(1550, 300 - 28, 1500, 1650, traits=["shadow"]),
                Wasp(1850, 540 - 24, 1800, 1980),
                Fly(2000, 360, 1950, 2150, traits=["poison"]),
                Spider(2150, 340 - 28, 2100, 2300, traits=["armor"]),
            ...
            enemies = scale_enemies([
                Spider(200, 440 - 28, 150, 350, traits=["armor"]),
                Spider(350, 360 - 28, 300, 450),
                Wasp(500, 540 - 24, 450, 650),
                Spider(600, 400 - 28, 550, 750, traits=["poison", "shadow"]),
                Fly(750, 240, 700, 900, traits=["shadow"]),
                Spider(900, 420 - 28, 850, 1050, traits=["armor"]),
                Wasp(1050, 540 - 24, 1000, 1200),
                Spider(1400, 400 - 28, 1350, 1550),
                Spider(1550, 300 - 28, 1500, 1700, traits=["poison"]),
                Fly(1700, 340, 1650, 1850),
                Wasp(1850, 540 - 24, 1800, 2000),
                Spider(2150, 480 - 28, 2100, 2300, traits=["armor", "shadow"]),
                Spider(2400, 400 - 28, 2350, 2550, traits=["poison"]),
                Fly(2550, 240, 2500, 2700),
                Spider(2700, 420 - 28, 2650, 2850, traits=["armor", "poison"]),
            ...
            enemies = scale_enemies([
                ...
                Spider(180, 440 - 28, 130, 300, traits=["armor"]),
                Fly(320, 290, 270, 470, traits=["shadow"]),
                Wasp(450, 540 - 24, 420, 570),
                Spider(550, 400 - 28, 500, 690, traits=["poison", "armor"]),
                Fly(690, 240, 640, 850),
                Wasp(830, 540 - 24, 800, 950),
                Spider(920, 420 - 28, 870, 1060, traits=["shadow"]),
                Spider(1060, 320 - 28, 1010, 1200, traits=["poison"]),
                Wasp(1300, 540 - 24, 1280, 1450),
                Fly(1450, 400, 1400, 1580),
                Spider(1580, 380 - 28, 1530, 1710, traits=["armor", "shadow"]),
                Fly(1710, 240, 1660, 1850),
                Wasp(1980, 540 - 24, 1950, 2100),
                Spider(2100, 420 - 28, 2050, 2250, traits=["poison", "shadow"]),
                Spider(2250, 340 - 28, 2200, 2400, traits=["armor"]),
            ...
            enemies = scale_enemies([
                ...
                Spider(500, 540 - 28, 450, 700, traits=["armor"]),
                Fly(600, 340, 550, 750, traits=["poison"]),
                Wasp(800, 540 - 24, 750, 950),
                Spider(900, 420 - 28, 850, 1000, traits=["shadow"]),
                Wasp(1100, 540 - 24, 1050, 1300),
                Fly(1200, 340, 1150, 1400, traits=["armor"]),
                Spider(1400, 540 - 28, 1350, 1550, traits=["poison", "shadow"]),
                Wasp(1500, 420 - 24, 1450, 1600),
                Fly(1700, 320, 1650, 1850, traits=["shadow"]),
                Spider(1800, 380 - 28, 1750, 1950, traits=["armor", "poison"]),
                Wasp(2000, 540 - 24, 1950, 2150),
                Spider(2100, 440 - 28, 2050, 2200, traits=["shadow"]),
                Fly(2300, 340, 2250, 2500),
                Wasp(2450, 400 - 24, 2400, 2600),
                Spider(2650, 540 - 28, 2600, 2850, traits=["armor", "poison", "shadow"]),
            ...
            enemies = scale_enemies([
                ...
                Fly(450, 290, 400, 600),
                Spider(620, 540 - 28, 580, 770, traits=["armor"]),
                Wasp(700, 400 - 24, 650, 850),
                Fly(880, 240, 830, 1050, traits=["poison", "shadow"]),
                Spider(1050, 420 - 28, 1000, 1200, traits=["armor", "poison"]),
                Wasp(1200, 540 - 24, 1150, 1350),
                Fly(1500, 340, 1450, 1650, traits=["shadow"]),
    ...
    # =========================================================================
        ...
        if level == 0:  # Shadow Gate — intro but still hard, mix of all enemies
            ...
            enemies = scale_enemies([
                Wasp(150, 540 - 24, 50, 300),
                Spider(430, 350 - 28, 380, 520, traits=["shadow"]),
                Fly(600, 400, 520, 730, traits=["ranged"]),
                Wasp(750, 540 - 24, 700, 920),
                Spider(870, 400 - 28, 820, 1000, traits=["poison", "armor"]),
                Fly(1030, 250, 980, 1180, traits=["shadow", "ranged"]),
                Wasp(1320, 540 - 24, 1270, 1520),
                Spider(1450, 400 - 28, 1400, 1600, traits=["armor", "shadow"]),
                Fly(1620, 250, 1570, 1750, traits=["poison"]),
                Wasp(1770, 540 - 24, 1720, 1900),
                Spider(1900, 420 - 28, 1850, 2050, traits=["poison", "shadow"]),
                Fly(2050, 280, 2000, 2200),
                Wasp(2400, 540 - 24, 2300, 2600),
                Spider(2550, 400 - 28, 2500, 2700, traits=["armor", "ranged"]),
            ...
            enemies = scale_enemies([
                # Wave 1
                Wasp(150, 540 - 24, 50, 350),
                Wasp(300, 440 - 24, 250, 450, traits=["poison"]),
                # Wave 2
                Spider(550, 540 - 28, 500, 780, traits=["armor"]),
                Fly(700, 360, 650, 900, traits=["ranged"]),
                Wasp(900, 540 - 24, 850, 1100),
                # Wave 3
                Spider(1050, 420 - 28, 1000, 1200, traits=["shadow"]),
                Wasp(1250, 540 - 24, 1200, 1450),
                Fly(1400, 340, 1350, 1600, traits=["poison", "ranged"]),
                # Wave 4
                Spider(1600, 540 - 28, 1550, 1800, traits=["armor", "shadow"]),
                Wasp(1700, 420 - 24, 1650, 1850),
                Fly(1900, 340, 1850, 2100, traits=["shadow"]),
                # Wave 5
                Spider(2050, 400 - 28, 2000, 2250, traits=["poison", "armor"]),
                Wasp(2250, 540 - 24, 2200, 2450),
                Spider(2400, 420 - 28, 2350, 2550, traits=["shadow", "ranged"]),
                # Wave 6
                Fly(2600, 340, 2550, 2800, traits=["poison"]),
                Wasp(2750, 400 - 24, 2700, 2950),
                Spider(2950, 540 - 28, 2900, 3150, traits=["armor"]),
                # Wave 7
                Wasp(3100, 440 - 24, 3050, 3250),
                Fly(3250, 480, 3200, 3450),
                Spider(3600, 540 - 28, 3550, 3800, traits=["poison", "shadow", "armor"]),
            ...
            enemies = scale_enemies([
                ...
                Fly(180, 200, 130, 350, traits=["shadow"]),
                Spider(350, 180 - 28, 300, 470, traits=["poison"]),
                Fly(480, 240, 430, 600),
                Spider(590, 420 - 28, 540, 700, traits=["armor"]),
                Wasp(660, 540 - 24, 620, 780),
                Fly(730, 190, 680, 870, traits=["ranged", "shadow"]),
                Spider(870, 250 - 28, 820, 1000, traits=["shadow"]),
                Fly(1000, 290, 950, 1110),
                Spider(1110, 460 - 28, 1060, 1200, traits=["poison", "armor"]),
                Wasp(1200, 540 - 24, 1150, 1330),
                Fly(1300, 220, 1220, 1400, traits=["ranged"]),
                Spider(1400, 280 - 28, 1350, 1500, traits=["shadow", "poison"]),
                Fly(1530, 410, 1450, 1630),
                Wasp(1740, 540 - 24, 1700, 1880),
                Spider(1800, 400 - 28, 1750, 1950, traits=["armor", "shadow"]),
                Fly(1950, 240, 1900, 2100),
                Wasp(2100, 400 - 24, 2050, 2200),
                Spider(2200, 500 - 28, 2150, 2350, traits=["poison", "armor", "ranged"]),
            ], hp_multiplier=5.0, speed_multiplier=1.3)
            ...
            enemies = scale_enemies([
                ...
                Spider(170, 430 - 28, 120, 310, traits=["shadow"]),
                Spider(310, 340 - 28, 260, 420, traits=["armor"]),
                Fly(450, 340, 400, 560, traits=["ranged"]),
                Wasp(530, 400 - 24, 480, 650),
                Spider(660, 290 - 28, 610, 800, traits=["poison", "shadow"]),
                Wasp(820, 540 - 24, 780, 930),
                Spider(900, 410 - 28, 850, 1040, traits=["armor"]),
                Fly(1040, 250, 990, 1170, traits=["shadow", "ranged"]),
                Wasp(1170, 420 - 24, 1120, 1280),
                Spider(1300, 540 - 28, 1250, 1420, traits=["poison"]),
                Fly(1430, 300, 1380, 1550, traits=["ranged", "poison"]),
                Spider(1550, 360 - 28, 1500, 1670, traits=["armor", "shadow"]),
                Wasp(1670, 280 - 24, 1620, 1800),
                Spider(1800, 380 - 28, 1750, 1930, traits=["poison", "armor"]),
                Fly(1930, 360, 1900, 2050),
                Wasp(2030, 420 - 24, 1980, 2170),
                Spider(2170, 330 - 28, 2120, 2310, traits=["shadow", "ranged"]),
                Wasp(2310, 440 - 24, 2260, 2420),
                Spider(2430, 540 - 28, 2380, 2600, traits=["armor", "poison", "shadow"]),
                Fly(2700, 340, 2650, 2850),
                Spider(2800, 400 - 28, 2750, 2950, traits=["ranged"]),
                Wasp(2950, 300 - 24, 2900, 3100),
                Spider(3100, 420 - 28, 3050, 3230, traits=["poison", "shadow", "armor"]),
            ], hp_multiplier=5.0, speed_multiplier=1.3)
            ...
            enemies = scale_enemies([
                Spider(230, 430 - 28, 180, 380, traits=["shadow"]),
                Spider(380, 340 - 28, 330, 500, traits=["armor"]),
                Wasp(550, 540 - 24, 500, 700),
                Spider(630, 400 - 28, 580, 780, traits=["poison"]),
                Spider(780, 300 - 28, 730, 930, traits=["ranged", "shadow"]),
                Fly(930, 360, 880, 1050, traits=["ranged"]),
                Spider(1050, 540 - 28, 1000, 1200),
                Spider(1400, 400 - 28, 1350, 1550, traits=["armor", "shadow"]),
                Spider(1550, 300 - 28, 1500, 1700, traits=["poison", "armor"]),
                Wasp(1700, 400 - 24, 1650, 1850),
                Spider(1850, 540 - 28, 1800, 2000, traits=["shadow"]),
                Spider(2150, 480 - 28, 2100, 2300, traits=["armor", "ranged"]),
                Fly(2300, 340, 2250, 2450),
                Spider(2400, 400 - 28, 2350, 2550, traits=["poison", "shadow"]),
                Spider(2550, 300 - 28, 2500, 2700, traits=["armor", "poison"]),
                Wasp(2700, 420 - 24, 2650, 2850),
                Spider(2850, 540 - 28, 2800, 3050, traits=["shadow", "ranged"]),
                Spider(3200, 540 - 28, 3150, 3350),
                Spider(3300, 400 - 28, 3250, 3450),
                Spider(3450, 300 - 28, 3400, 3600, traits=["poison", "armor", "shadow"]),
                Wasp(3600, 420 - 24, 3550, 3750),
                Spider(3750, 540 - 28, 3700, 3900),
                Spider(4050, 540 - 28, 4000, 4200, traits=["armor", "shadow", "ranged"]),
            ...
            enemies = scale_enemies([
                ...
                Fly(160, 290, 110, 300, traits=["shadow"]),
                Spider(290, 340 - 28, 240, 400, traits=["armor"]),
                Wasp(400, 540 - 24, 370, 500),
                Spider(480, 400 - 28, 430, 610, traits=["poison"]),
                Fly(610, 240, 560, 740, traits=["ranged", "shadow"]),
                Spider(740, 400 - 28, 690, 860, traits=["armor"]),
                Wasp(870, 540 - 24, 830, 960),
                Spider(940, 420 - 28, 890, 1070, traits=["shadow", "poison"]),
                Fly(1070, 260, 1020, 1200, traits=["ranged"]),
                Wasp(1200, 420 - 24, 1150, 1300),
                Spider(1310, 540 - 28, 1260, 1420, traits=["armor", "shadow"]),
                Fly(1430, 390, 1380, 1550),
                Spider(1550, 360 - 28, 1500, 1670, traits=["poison", "ranged"]),
                Wasp(1670, 270 - 24, 1620, 1800),
                Fly(1800, 320, 1750, 1910, traits=["shadow"]),
                Spider(1910, 480 - 28, 1860, 2040, traits=["armor", "poison"]),
                Wasp(2040, 540 - 24, 2000, 2120),
                Spider(2130, 400 - 28, 2080, 2260, traits=["shadow", "ranged"]),
                Fly(2260, 240, 2210, 2390),
                Spider(2390, 400 - 28, 2340, 2510, traits=["armor"]),
                Wasp(2500, 540 - 24, 2460, 2610),
                Spider(2620, 440 - 28, 2570, 2740, traits=["poison", "shadow"]),
                Fly(2740, 280, 2690, 2860),
                Spider(2860, 250 - 28, 2810, 2980, traits=["armor", "ranged", "poison"]),
                Wasp(2980, 360 - 24, 2930, 3120),
                Spider(3120, 540 - 28, 3080, 3200),
                Fly(3200, 340, 3150, 3330),
                Spider(3330, 300 - 28, 3280, 3450, traits=["poison", "shadow", "armor", "ranged"]),
            ...
            enemies = scale_enemies([
                Wasp(150, 540 - 24, 50, 300),
                Fly(430, 290, 380, 580, traits=["ranged", "shadow"]),
                Spider(600, 540 - 28, 550, 740, traits=["armor", "poison"]),
                Wasp(700, 400 - 24, 650, 860),
                Fly(880, 240, 830, 1050, traits=["ranged", "poison"]),
                Spider(1050, 420 - 28, 1000, 1200, traits=["armor", "shadow"]),
                Wasp(1200, 540 - 24, 1150, 1350),
                Fly(1500, 340, 1450, 1650, traits=["shadow", "ranged"]),
                Wasp(1600, 540 - 24, 1550, 1750),
            ], hp_multiplier=5.0, speed_multiplier=1.3)
